...
let questionsAndAnswers = [
    ...
    { question: "ما هو اسم أطول برج في المملكة؟", answer: "برج المملكة" },
  ...
  function checkAnswer() {
    ...
    if (userAnswer.trim().toLowerCase() === correctAnswer.trim().toLowerCase()) {
      document.getElementById("result").innerHTML = `أحسنت يا ${userData.user} إجابة صحيحة.`;
  ...
  async function checkWeather(city, Temp, icon) {
    ...
    if (response.ok) {
      ...
      console.log("لم يتم العثور على المدينة");
    }
  }
